        ...
        <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form action="/register" method="POST" id="registration-form">
            ...
            <div class="form-group">
                ...
                <input name="name" id="name-register" class="form-control" value="{{ old('name') }}" type="text" placeholder="Your name" autocomplete="off" />
                @error('name')
            ...
            <div class="form-group">
                ...
                <input name="email" id="email-register" class="form-control" value="{{ old('email') }}" type="text" placeholder="you@example.com" autocomplete="off" />
                @error('email')
                    <p class="m-0 small text-danger">{{ $message }}</p>
                @enderror
            </div>
